...
void SetDlgControls (HWND hWnd, tAC97Features *pAC97Features)
{
    ...
    iRes = LoadString(ghInstance, IDS_PROP_NO, No, _ARRAYSIZE(No));
    iRes = LoadString(ghInstance, IDS_PROP_NA, NA, _ARRAYSIZE(NA));
    iRes = LoadString(ghInstance, IDS_PROP_18, R18, _ARRAYSIZE(R18));
    iRes = LoadString(ghInstance, IDS_PROP_20, R20, _ARRAYSIZE(R20));
